...
function Hero() {
  return (
    <section style={{
      ...
      <div style={{maxWidth:1040,margin:"0 auto",fontFamily:"var(--font-sans)"}}>
        <h1 style={{fontFamily:"var(--font-mono)",fontWeight:500,fontSize:72,lineHeight:1.02,letterSpacing:"-2px",margin:"0 0 20px",color:"#B2ED1D"}}>
          A semantic namespace<br/>for industrial data.
        </h1>
